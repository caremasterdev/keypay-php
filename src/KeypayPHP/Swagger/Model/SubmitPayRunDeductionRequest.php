 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SubmitPayRunDeductionRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SubmitPayRunDeductionRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'deductions' => 'map[string,\Swagger\Client\Model\DeductionModel[]]',
        'pay_run_id' => 'int',
    ...
    {
        $this->container['deduction_category_id_type'] = isset($data['deduction_category_id_type']) ? $data['deduction_category_id_type'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (! is_null($this->container['deduction_category_id_type']) && ! in_array($this->container['deduction_category_id_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'deduction_category_id_type', must be one of '%s'",
     ...
     *
     * @param string $deduction_category_id_type
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getDeductionCategoryIdTypeAllowableValues();
        if (! is_null($deduction_category_id_type) && ! in_array($deduction_category_id_type, $allowedValues, true)) {
     ...
     * Gets deductions
     *
     * @return map[string,\Swagger\Client\Model\DeductionModel[]]
     */
     ...
     * Sets deductions
     *
     * @param map[string,\Swagger\Client\Model\DeductionModel[]] $deductions
     *
     * @return $this
     */
