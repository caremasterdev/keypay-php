 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SubmitPayRunEmployeeExpenseRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SubmitPayRunEmployeeExpenseRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'expenses' => 'map[string,\Swagger\Client\Model\EmployeeExpenseModel[]]',
        'pay_run_id' => 'int',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['employee_expense_category_id_type'] = isset($data['employee_expense_category_id_type']) ? $data['employee_expense_category_id_type'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (! is_null($this->container['employee_expense_category_id_type']) && ! in_array($this->container['employee_expense_category_id_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'employee_expense_category_id_type', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     *
     * @param string $employee_expense_category_id_type
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getEmployeeExpenseCategoryIdTypeAllowableValues();
        if (! is_null($employee_expense_category_id_type) && ! in_array($employee_expense_category_id_type, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'employee_expense_category_id_type', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     * Gets expenses
     *
     * @return map[string,\Swagger\Client\Model\EmployeeExpenseModel[]]
     */
     ...
     * Sets expenses
     *
     * @param map[string,\Swagger\Client\Model\EmployeeExpenseModel[]] $expenses
     *
     * @return $this
     */
