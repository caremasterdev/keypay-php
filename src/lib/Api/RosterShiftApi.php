...
class RosterShiftApi
{
     ...
     * Create roster shift
     *
     * @param  \Swagger\Client\Model\AuRosterShiftEditModel $shift_model shift_model (required)
     ...
     * @return void
     */
    public function auRosterShiftPost($shift_model, $publish, $business_id)
    {
        $this->auRosterShiftPostWithHttpInfo($shift_model, $publish, $business_id);
    }
     ...
     * Create roster shift
     *
     * @param  \Swagger\Client\Model\AuRosterShiftEditModel $shift_model (required)
     ...
     */
    public function auRosterShiftPostWithHttpInfo($shift_model, $publish, $business_id)
    {
        $returnType = '';
        $request = $this->auRosterShiftPostRequest($shift_model, $publish, $business_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function auRosterShiftPostAsync($shift_model, $publish, $business_id)
    {
        return $this->auRosterShiftPostAsyncWithHttpInfo($shift_model, $publish, $business_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function auRosterShiftPostAsyncWithHttpInfo($shift_model, $publish, $business_id)
    {
        $returnType = '';
        $request = $this->auRosterShiftPostRequest($shift_model, $publish, $business_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function auRosterShiftPostRequest($shift_model, $publish, $business_id)
    {
     ...
     * @return void
     */
    public function auRosterShiftPut($shift_model, $roster_shift_id, $publish, $business_id)
    {
        $this->auRosterShiftPutWithHttpInfo($shift_model, $roster_shift_id, $publish, $business_id);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function auRosterShiftPutWithHttpInfo($shift_model, $roster_shift_id, $publish, $business_id)
    {
        $returnType = '';
        $request = $this->auRosterShiftPutRequest($shift_model, $roster_shift_id, $publish, $business_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function auRosterShiftPutAsync($shift_model, $roster_shift_id, $publish, $business_id)
    {
        return $this->auRosterShiftPutAsyncWithHttpInfo($shift_model, $roster_shift_id, $publish, $business_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function auRosterShiftPutAsyncWithHttpInfo($shift_model, $roster_shift_id, $publish, $business_id)
    {
        $returnType = '';
        $request = $this->auRosterShiftPutRequest($shift_model, $roster_shift_id, $publish, $business_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function auRosterShiftPutRequest($shift_model, $roster_shift_id, $publish, $business_id)
    {
        // verify the required parameter 'shift_model' is set
        if ($shift_model === null || (is_array($shift_model) && count($shift_model) === 0)) {
            throw new \InvalidArgumentException(
