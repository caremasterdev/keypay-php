...
/**
 * SubmitLeaveAccrualsModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SubmitLeaveAccrualsModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubmitLeaveAccrualsModel';
    ...
    protected static $openAPITypes = [
        ...
        'leave' => 'array<string,\OpenAPI\Client\Model\SaveLeaveAccrualModel[]>'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('leave', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets leave
     *
     * @return array<string,\OpenAPI\Client\Model\SaveLeaveAccrualModel[]>|null
     */
     ...
     * Sets leave
     *
     * @param array<string,\OpenAPI\Client\Model\SaveLeaveAccrualModel[]>|null $leave 
     *
     * @return self
     */
    ...
    {
        if (is_null($leave)) {
            throw new \InvalidArgumentException('non-nullable leave cannot be null');
        }
