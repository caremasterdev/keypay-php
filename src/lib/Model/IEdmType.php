...
class IEdmType implements ModelInterface, ArrayAccess
{
    ...
    const TYPE_KIND_NONE = 'None';
    const TYPE_KIND_PRIMITIVE = 'Primitive';
    const TYPE_KIND_ENTITY = 'Entity';
    const TYPE_KIND_COMPLEX = 'Complex';
    const TYPE_KIND_ROW = 'Row';
    const TYPE_KIND_COLLECTION = 'Collection';
    const TYPE_KIND_ENTITY_REFERENCE = 'EntityReference';
    const TYPE_KIND_ENUM = 'Enum';
