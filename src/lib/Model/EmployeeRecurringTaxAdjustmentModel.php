 ...
 */
class EmployeeRecurringTaxAdjustmentModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmployeeRecurringTaxAdjustmentModel';
