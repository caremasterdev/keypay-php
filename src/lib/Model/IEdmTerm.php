 ...
 */
class IEdmTerm implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IEdmTerm';
    ...
    public const TERM_KIND_NONE = 'None';
    public const TERM_KIND_TYPE = 'Type';
    public const TERM_KIND_VALUE = 'Value';
    ...
    {
        $this->setIfExists('term_kind', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['term_kind']) && !in_array($this->container['term_kind'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'term_kind', must be one of '%s'",
                $this->container['term_kind'],
     ...
     * Sets term_kind
     *
     * @param string|null $term_kind 
     *
     * @return self
     */
    public function setTermKind($term_kind)
    {
        if (is_null($term_kind)) {
            throw new \InvalidArgumentException('non-nullable term_kind cannot be null');
        }
        $allowedValues = $this->getTermKindAllowableValues();
        if (!in_array($term_kind, $allowedValues, true)) {
