 ...
 */
class AuApiPaySlipBankPaymentModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuApiPaySlipBankPaymentModel';
