...
/**
 * NominalWorkType Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NominalWorkType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NominalWorkType';
    ...
    public const LINK_TYPE_PAY_CATEGORY = 'PayCategory';
    public const LINK_TYPE_LEAVE_CATEGORY = 'LeaveCategory';
    public const LINK_TYPE_SHIFT_CONDITION = 'ShiftCondition';
    ...
    {
        return [
            self::LINK_TYPE_PAY_CATEGORY,
            self::LINK_TYPE_LEAVE_CATEGORY,
            self::LINK_TYPE_SHIFT_CONDITION,
        ];
    }
