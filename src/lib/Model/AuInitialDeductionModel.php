 ...
 */
class AuInitialDeductionModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuInitialDeductionModel';
    ...
    protected static array $openAPINullables = [
        'is_resc' => false,
		'tax_exempt' => false,
		'is_member_voluntary' => false,
		'is_resc_status_read_only' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_member_voluntary', $data ?? [], null);
        $this->setIfExists('is_resc_status_read_only', $data ?? [], null);
    ...
    */
     ...
     *
     * @param bool|null $is_member_voluntary 
     *
     * @return self
     */
    public function setIsMemberVoluntary($is_member_voluntary)
    {
        if (is_null($is_member_voluntary)) {
            throw new \InvalidArgumentException('non-nullable is_member_voluntary cannot be null');
        }
     ...
     *
     * @param bool|null $is_resc_status_read_only 
     *
     * @return self
     */
    public function setIsRescStatusReadOnly($is_resc_status_read_only)
    {
        if (is_null($is_resc_status_read_only)) {
            throw new \InvalidArgumentException('non-nullable is_resc_status_read_only cannot be null');
        }
