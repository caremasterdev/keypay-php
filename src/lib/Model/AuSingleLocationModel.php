 ...
 */
class AuSingleLocationModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuSingleLocationModel';
    ...
    protected static $openAPITypes = [
        'nested_locations' => '\OpenAPI\Client\Model\AuLocationModel[]',
        'country' => 'string',
        'id' => 'int',
        'parent_id' => 'int',
        'name' => 'string',
    ...
    {
        $this->setIfExists('nested_locations', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\AuLocationModel[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AuLocationModel[]|null $nested_locations 
     *
     * @return self
     */
    public function setNestedLocations($nested_locations)
    {
        if (is_null($nested_locations)) {
            throw new \InvalidArgumentException('non-nullable nested_locations cannot be null');
        }
