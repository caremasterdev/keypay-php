 ...
 */
class UpdateDocumentPermissionsModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateDocumentPermissionsModel';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('visible_to_all', $data ?? [], null);
    ...
    */
     ...
     * Sets visible_to_all
     *
     * @param bool|null $visible_to_all 
     *
     * @return self
     */
    public function setVisibleToAll($visible_to_all)
    {
        if (is_null($visible_to_all)) {
            throw new \InvalidArgumentException('non-nullable visible_to_all cannot be null');
        }
     ...
     *
     * @param int[]|null $employee_groups 
     *
     * @return self
     */
