...
class RecoverPasswordModel implements ModelInterface, ArrayAccess
{
    ...
    const MESSAGE_TYPE_EMPLOYEE_SELF_SETUP_REMINDER = 'EmployeeSelfSetupReminder';
    const MESSAGE_TYPE_EMPLOYEE_ONBOARDING_P45_UPLOADED = 'EmployeeOnboardingP45Uploaded';
    const MESSAGE_TYPE_INITIATE_EMPLOYEE_ONBOARDING_WITH_CONTRACT = 'InitiateEmployeeOnboardingWithContract';
    const MESSAGE_TYPE_SIGNATORY_CONTRACT = 'SignatoryContract';
    const MESSAGE_TYPE_WORK_ELIGIBILITY_EXPIRING_NOTIFICATION = 'WorkEligibilityExpiringNotification';
    const MESSAGE_TYPE_WORK_ELIGIBILITY_EXPIRED_NOTIFICATION = 'WorkEligibilityExpiredNotification';
    const MESSAGE_TYPE_CONTRACT_SIGNED_EMPLOYEE_NOTIFICATION = 'ContractSignedEmployeeNotification';
    const MESSAGE_TYPE_CONTRACT_SIGNED_EMPLOYER_NOTIFICATION = 'ContractSignedEmployerNotification';
    const MESSAGE_TYPE_INITIATE_EMPLOYEE_ONBOARDING_WITH_LOGIN = 'InitiateEmployeeOnboardingWithLogin';
    const MESSAGE_TYPE_AUTHORISING_SIGNATORY_NOTIFICATION = 'AuthorisingSignatoryNotification';
    const MESSAGE_TYPE_INTEGRATION_CUSTOM_FEATURE_REQUEST = 'IntegrationCustomFeatureRequest';
    const MESSAGE_TYPE_EMAIL_ADDRESS_CHANGED = 'EmailAddressChanged';
    const MESSAGE_TYPE_EMAIL_ADDRESS_CONFIRM_CHANGED = 'EmailAddressConfirmChanged';
    const MESSAGE_TYPE_RECOVERY_EMAIL_ADDRESS_CHANGED = 'RecoveryEmailAddressChanged';
    const MESSAGE_TYPE_RECOVERY_EMAIL_ADDRESS_CONFIRM_CHANGED = 'RecoveryEmailAddressConfirmChanged';
