 ...
 */
class AuRosterShiftGenerateTimesheetModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuRosterShiftGenerateTimesheetModel';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_different', $data ?? [], null);
    ...
    */
     ...
     * Sets is_different
     *
     * @param bool|null $is_different 
     *
     * @return self
     */
    public function setIsDifferent($is_different)
    {
        if (is_null($is_different)) {
            throw new \InvalidArgumentException('non-nullable is_different cannot be null');
        }
