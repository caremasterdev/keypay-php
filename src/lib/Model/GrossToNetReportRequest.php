...
/**
 * GrossToNetReportRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GrossToNetReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GrossToNetReportRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('pay_category_ids', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets pay_category_ids
     *
     * @return int[]|null
     */
    public function getPayCategoryIds()
    {
        return $this->container['pay_category_ids'];
    }

    /**
     * Sets pay_category_ids
     *
     * @param int[]|null $pay_category_ids 
     *
     * @return self
     */
    public function setPayCategoryIds($pay_category_ids)
    {
        if (is_null($pay_category_ids)) {
            throw new \InvalidArgumentException('non-nullable pay_category_ids cannot be null');
        }
        $this->container['pay_category_ids'] = $pay_category_ids;
