...
/**
 * SubmitPayRunDeductionRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SubmitPayRunDeductionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubmitPayRunDeductionRequest';
    ...
    protected static $openAPITypes = [
        'deduction_category_id_type' => 'string',
        'deductions' => 'array<string,\OpenAPI\Client\Model\DeductionModel[]>',
        'pay_run_id' => 'int',
    ...
    protected static $openAPIFormats = [
        'deduction_category_id_type' => null,
        'deductions' => null,
        'pay_run_id' => 'int32',
    ...
    protected static array $openAPINullables = [
        'deduction_category_id_type' => false,
		'deductions' => false,
		'pay_run_id' => false,
    ...
    protected static $attributeMap = [
        'deduction_category_id_type' => 'deductionCategoryIdType',
    ...
    protected static $setters = [
        'deduction_category_id_type' => 'setDeductionCategoryIdType',
    ...
    protected static $getters = [
        'deduction_category_id_type' => 'getDeductionCategoryIdType',
    ...
    public const DEDUCTION_CATEGORY_ID_TYPE_STANDARD = 'Standard';
    public const DEDUCTION_CATEGORY_ID_TYPE_EXTERNAL = 'External';
     ...
     * @return string[]
     */
    public function getDeductionCategoryIdTypeAllowableValues()
    {
        return [
            self::DEDUCTION_CATEGORY_ID_TYPE_STANDARD,
            self::DEDUCTION_CATEGORY_ID_TYPE_EXTERNAL,
        ];
    }
    ...
    {
        $this->setIfExists('deduction_category_id_type', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getDeductionCategoryIdTypeAllowableValues();
        if (!is_null($this->container['deduction_category_id_type']) && !in_array($this->container['deduction_category_id_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'deduction_category_id_type', must be one of '%s'",
                $this->container['deduction_category_id_type'],
    ...
    /**
     * Gets deduction_category_id_type
     *
     * @return string|null
     */
    public function getDeductionCategoryIdType()
    {
        return $this->container['deduction_category_id_type'];
    }

    /**
     * Sets deduction_category_id_type
     *
     * @param string|null $deduction_category_id_type 
     *
     * @return self
     */
    public function setDeductionCategoryIdType($deduction_category_id_type)
    {
        if (is_null($deduction_category_id_type)) {
            throw new \InvalidArgumentException('non-nullable deduction_category_id_type cannot be null');
        }
        $allowedValues = $this->getDeductionCategoryIdTypeAllowableValues();
        if (!in_array($deduction_category_id_type, $allowedValues, true)) {
        ...
        $this->container['deduction_category_id_type'] = $deduction_category_id_type;
     ...
     * Gets deductions
     *
     * @return array<string,\OpenAPI\Client\Model\DeductionModel[]>|null
     */
     ...
     * Sets deductions
     *
     * @param array<string,\OpenAPI\Client\Model\DeductionModel[]>|null $deductions 
     *
     * @return self
     */
