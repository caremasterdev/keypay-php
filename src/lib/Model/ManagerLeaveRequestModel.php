 ...
 */
class ManagerLeaveRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagerLeaveRequestModel';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('accrued_balance', $data ?? [], null);
        $this->setIfExists('exceeds_balance', $data ?? [], null);
    ...
    */
     ...
     *
     * @param float|null $accrued_balance 
     *
     * @return self
     */
    public function setAccruedBalance($accrued_balance)
    {
        if (is_null($accrued_balance)) {
            throw new \InvalidArgumentException('non-nullable accrued_balance cannot be null');
        }
     ...
     *
     * @param bool|null $exceeds_balance 
     *
     * @return self
     */
    public function setExceedsBalance($exceeds_balance)
    {
        if (is_null($exceeds_balance)) {
            throw new \InvalidArgumentException('non-nullable exceeds_balance cannot be null');
        }
