 ...
 */
class DocumentAcknowledgementsReportExportModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentAcknowledgementsReportExportModel';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('last_notification', $data ?? [], null);
    ...
    */
     ...
     *
     * @param \DateTime|null $last_notification 
     *
     * @return self
     */
    public function setLastNotification($last_notification)
    {
        if (is_null($last_notification)) {
            throw new \InvalidArgumentException('non-nullable last_notification cannot be null');
        }
