...
class AuRosterTimesheetComparisonReportRequestModel implements ModelInterface, ArrayAccess
{
    ...
    const TIMESHEET_STATUSES_MISSING = 'Missing';
    const TIMESHEET_STATUSES_SUBMITTED = 'Submitted';
    const TIMESHEET_STATUSES_APPROVED = 'Approved';
    const TIMESHEET_STATUSES_REJECTED = 'Rejected';
    const TIMESHEET_STATUSES_PROCESSED = 'Processed';
    const ROSTER_STATUSES_ALL = 'All';
    const ROSTER_STATUSES_PUBLISHED = 'Published';
    const ROSTER_STATUSES_UNPUBLISHED = 'Unpublished';
    const ROSTER_STATUSES_ACCEPTED = 'Accepted';
