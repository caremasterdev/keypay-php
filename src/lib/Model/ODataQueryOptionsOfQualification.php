 ...
 */
class ODataQueryOptionsOfQualification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ODataQueryOptionsOfQualification';
