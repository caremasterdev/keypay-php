 ...
 */
class PayScheduleDateForecastResultApiModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayScheduleDateForecastResultApiModel';
    ...
    protected static array $openAPINullables = [
		...
		'next_scheduled_from_date' => false,
		'next_scheduled_to_date' => false,
		'next_scheduled_paid_date' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('next_scheduled_from_date', $data ?? [], null);
        $this->setIfExists('next_scheduled_to_date', $data ?? [], null);
        $this->setIfExists('next_scheduled_paid_date', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param \DateTime|null $next_scheduled_from_date 
     *
     * @return self
     */
    public function setNextScheduledFromDate($next_scheduled_from_date)
    {
        if (is_null($next_scheduled_from_date)) {
            throw new \InvalidArgumentException('non-nullable next_scheduled_from_date cannot be null');
        }
     ...
     *
     * @param \DateTime|null $next_scheduled_to_date 
     *
     * @return self
     */
    public function setNextScheduledToDate($next_scheduled_to_date)
    {
        if (is_null($next_scheduled_to_date)) {
            throw new \InvalidArgumentException('non-nullable next_scheduled_to_date cannot be null');
        }
     ...
     *
     * @param \DateTime|null $next_scheduled_paid_date 
     *
     * @return self
     */
    public function setNextScheduledPaidDate($next_scheduled_paid_date)
    {
        if (is_null($next_scheduled_paid_date)) {
            throw new \InvalidArgumentException('non-nullable next_scheduled_paid_date cannot be null');
        }
