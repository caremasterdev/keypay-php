 ...
 */
class DeductionsReportRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeductionsReportRequestModel';
    ...
    protected static array $openAPINullables = [
		...
		'disable_rollup_reporting' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('disable_rollup_reporting', $data ?? [], null);
    ...
    */
     ...
     *
     * @param bool|null $disable_rollup_reporting 
     *
     * @return self
     */
    public function setDisableRollupReporting($disable_rollup_reporting)
    {
        if (is_null($disable_rollup_reporting)) {
            throw new \InvalidArgumentException('non-nullable disable_rollup_reporting cannot be null');
        }
