...
/**
 * MissingLeaveResult Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MissingLeaveResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MissingLeaveResult';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('pay_run_ids', $data ?? [], null);
    }
    ...
    */
     ...
     * @return int[]|null
     */
    public function getPayRunIds()
    {
        return $this->container['pay_run_ids'];
    }

    /**
     * Sets pay_run_ids
     *
     * @param int[]|null $pay_run_ids 
     *
     * @return self
     */
    public function setPayRunIds($pay_run_ids)
    {
        if (is_null($pay_run_ids)) {
            throw new \InvalidArgumentException('non-nullable pay_run_ids cannot be null');
        }
        $this->container['pay_run_ids'] = $pay_run_ids;
