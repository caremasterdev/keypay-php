...
/**
 * PayRateTemplatePayCategoryExportModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PayRateTemplatePayCategoryExportModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayRateTemplatePayCategoryExportModel';
    ...
    protected static array $openAPINullables = [
		...
		'user_supplied_rate' => false,
		'calculated_rate' => false,
		'standard_weekly_hours' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('user_supplied_rate', $data ?? [], null);
        $this->setIfExists('calculated_rate', $data ?? [], null);
        $this->setIfExists('standard_weekly_hours', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param float|null $user_supplied_rate 
     *
     * @return self
     */
    public function setUserSuppliedRate($user_supplied_rate)
    {
        if (is_null($user_supplied_rate)) {
            throw new \InvalidArgumentException('non-nullable user_supplied_rate cannot be null');
        }
     ...
     *
     * @param float|null $standard_weekly_hours 
     *
     * @return self
     */
    public function setStandardWeeklyHours($standard_weekly_hours)
    {
        if (is_null($standard_weekly_hours)) {
            throw new \InvalidArgumentException('non-nullable standard_weekly_hours cannot be null');
        }
