...
/**
 * EssWorkTypeModel Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EssWorkTypeModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EssWorkTypeModel';
    ...
    const EMPLOYMENT_TYPES_NOT_APPLICABLE = 'NotApplicable';
    const EMPLOYMENT_TYPES_INDEPENDENT_CONTRACTOR = 'IndependentContractor';
