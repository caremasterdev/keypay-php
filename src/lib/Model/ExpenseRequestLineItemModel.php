...
/**
 * ExpenseRequestLineItemModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExpenseRequestLineItemModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('expense_category_name', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $expense_category_name 
     *
     * @return self
     */
    public function setExpenseCategoryName($expense_category_name)
    {
        if (is_null($expense_category_name)) {
            throw new \InvalidArgumentException('non-nullable expense_category_name cannot be null');
        }
    ...
    public function setNotes($notes)
    {
        ...
        if ((mb_strlen($notes) > 255)) {
            throw new \InvalidArgumentException('invalid length for $notes when calling ExpenseRequestLineItemModel., must be smaller than or equal to 255.');
        }
