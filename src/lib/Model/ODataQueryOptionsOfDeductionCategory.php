 ...
 */
class ODataQueryOptionsOfDeductionCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ODataQueryOptionsOfDeductionCategory';
