 ...
 */
class SubmitPayRunEmployerLiabilityRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubmitPayRunEmployerLiabilityRequest';
    ...
    protected static $openAPITypes = [
        ...
        'employer_liabilities' => 'array<string,\OpenAPI\Client\Model\EmployerLiabilityModel[]>',
        'pay_run_id' => 'int',
    ...
    protected static array $openAPINullables = [
        'employer_liability_category_id_type' => false,
    ...
    public const EMPLOYER_LIABILITY_CATEGORY_ID_TYPE_STANDARD = 'Standard';
    public const EMPLOYER_LIABILITY_CATEGORY_ID_TYPE_EXTERNAL = 'External';
    ...
    {
        $this->setIfExists('employer_liability_category_id_type', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['employer_liability_category_id_type']) && !in_array($this->container['employer_liability_category_id_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'employer_liability_category_id_type', must be one of '%s'",
                $this->container['employer_liability_category_id_type'],
     ...
     *
     * @param string|null $employer_liability_category_id_type 
     *
     * @return self
     */
    public function setEmployerLiabilityCategoryIdType($employer_liability_category_id_type)
    {
        if (is_null($employer_liability_category_id_type)) {
            throw new \InvalidArgumentException('non-nullable employer_liability_category_id_type cannot be null');
        }
        $allowedValues = $this->getEmployerLiabilityCategoryIdTypeAllowableValues();
        if (!in_array($employer_liability_category_id_type, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'employer_liability_category_id_type', must be one of '%s'",
                    $employer_liability_category_id_type,
                    implode("', '", $allowedValues)
                )
            );
        }
     ...
     *
     * @return array<string,\OpenAPI\Client\Model\EmployerLiabilityModel[]>|null
     */
     ...
     *
     * @param array<string,\OpenAPI\Client\Model\EmployerLiabilityModel[]>|null $employer_liabilities 
     *
     * @return self
     */
