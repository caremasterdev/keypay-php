 ...
 */
class ODataQueryOptionsOfSelfManagedSuperFund implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ODataQueryOptionsOfSelfManagedSuperFund';
