 ...
 */
class EmployerLiabilityCategoryModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmployerLiabilityCategoryModel';
    ...
    */
     ...
     *
     * @param bool|null $hide_from_pay_slips 
     *
     * @return self
     */
    public function setHideFromPaySlips($hide_from_pay_slips)
    {
        if (is_null($hide_from_pay_slips)) {
            throw new \InvalidArgumentException('non-nullable hide_from_pay_slips cannot be null');
        }
     ...
     *
     * @param bool|null $show_total_payments 
     *
     * @return self
     */
    public function setShowTotalPayments($show_total_payments)
    {
        if (is_null($show_total_payments)) {
            throw new \InvalidArgumentException('non-nullable show_total_payments cannot be null');
        }
     ...
     *
     * @param bool|null $include_in_shift_costs 
     *
     * @return self
     */
    public function setIncludeInShiftCosts($include_in_shift_costs)
    {
        if (is_null($include_in_shift_costs)) {
