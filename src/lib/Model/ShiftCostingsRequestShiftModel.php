 ...
 */
class ShiftCostingsRequestShiftModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShiftCostingsRequestShiftModel';
