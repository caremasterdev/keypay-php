 ...
 */
class BasicEmploymentAgreementModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BasicEmploymentAgreementModel';
