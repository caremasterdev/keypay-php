...
/**
 * SubmitPayRunEmployeeExpenseRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SubmitPayRunEmployeeExpenseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubmitPayRunEmployeeExpenseRequest';
    ...
    protected static $openAPITypes = [
        ...
        'employee_expense_category_id_type' => 'string',
        'expenses' => 'array<string,\OpenAPI\Client\Model\EmployeeExpenseModel[]>',
        'pay_run_id' => 'int',
    ...
    protected static $openAPIFormats = [
        ...
        'employee_expense_category_id_type' => null,
        'expenses' => null,
        'pay_run_id' => 'int32',
    ...
    protected static array $openAPINullables = [
		...
		'employee_expense_category_id_type' => false,
		'expenses' => false,
		'pay_run_id' => false,
    ...
    protected static $attributeMap = [
        ...
        'employee_expense_category_id_type' => 'employeeExpenseCategoryIdType',
        'expenses' => 'expenses',
        'pay_run_id' => 'payRunId',
    ...
    protected static $setters = [
        ...
        'employee_expense_category_id_type' => 'setEmployeeExpenseCategoryIdType',
    ...
    protected static $getters = [
        ...
        'employee_expense_category_id_type' => 'getEmployeeExpenseCategoryIdType',
    ...
    public const EMPLOYEE_EXPENSE_CATEGORY_ID_TYPE_STANDARD = 'Standard';
    public const EMPLOYEE_EXPENSE_CATEGORY_ID_TYPE_EXTERNAL = 'External';
     ...
     * @return string[]
     */
    public function getEmployeeExpenseCategoryIdTypeAllowableValues()
    {
        return [
            self::EMPLOYEE_EXPENSE_CATEGORY_ID_TYPE_STANDARD,
            self::EMPLOYEE_EXPENSE_CATEGORY_ID_TYPE_EXTERNAL,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('employee_expense_category_id_type', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getEmployeeExpenseCategoryIdTypeAllowableValues();
        if (!is_null($this->container['employee_expense_category_id_type']) && !in_array($this->container['employee_expense_category_id_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'employee_expense_category_id_type', must be one of '%s'",
                $this->container['employee_expense_category_id_type'],
                implode("', '", $allowedValues)
            );
        }
    ...
    /**
     * Gets employee_expense_category_id_type
     *
     * @return string|null
     */
    public function getEmployeeExpenseCategoryIdType()
    {
        return $this->container['employee_expense_category_id_type'];
    }

    /**
     * Sets employee_expense_category_id_type
     *
     * @param string|null $employee_expense_category_id_type 
     *
     * @return self
     */
    public function setEmployeeExpenseCategoryIdType($employee_expense_category_id_type)
    {
        if (is_null($employee_expense_category_id_type)) {
            throw new \InvalidArgumentException('non-nullable employee_expense_category_id_type cannot be null');
        }
        $allowedValues = $this->getEmployeeExpenseCategoryIdTypeAllowableValues();
        if (!in_array($employee_expense_category_id_type, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'employee_expense_category_id_type', must be one of '%s'",
                    $employee_expense_category_id_type,
                    implode("', '", $allowedValues)
                )
            );
        }
        $this->container['employee_expense_category_id_type'] = $employee_expense_category_id_type;
     ...
     * Gets expenses
     *
     * @return array<string,\OpenAPI\Client\Model\EmployeeExpenseModel[]>|null
     */
     ...
     * Sets expenses
     *
     * @param array<string,\OpenAPI\Client\Model\EmployeeExpenseModel[]>|null $expenses 
     *
     * @return self
     */
