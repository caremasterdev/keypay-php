 ...
 */
class TimesheetReportRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TimesheetReportRequestModel';
    ...
    public const STATUSES_MISSING = 'Missing';
    public const STATUSES_SUBMITTED = 'Submitted';
    public const STATUSES_APPROVED = 'Approved';
    public const STATUSES_REJECTED = 'Rejected';
    public const STATUSES_PROCESSED = 'Processed';
