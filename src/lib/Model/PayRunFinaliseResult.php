...
class PayRunFinaliseResult implements ModelInterface, ArrayAccess
{
    ...
    const PUBLISH_PREFERENCE_MANUAL = 'Manual';
    const PUBLISH_PREFERENCE_IMMEDIATE = 'Immediate';
    const PUBLISH_PREFERENCE_SCHEDULED = 'Scheduled';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_first_finalisation'] = isset($data['is_first_finalisation']) ? $data['is_first_finalisation'] : null;
    }
     ...
     *
     * @param bool $is_first_finalisation 
     *
     * @return $this
     */
