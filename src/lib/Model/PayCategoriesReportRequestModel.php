 ...
 */
class PayCategoriesReportRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayCategoriesReportRequestModel';
    ...
    protected static array $openAPINullables = [
		...
		'employee_id' => false,
		'group_by_earnings_location' => false,
		'from_date' => false,
		'to_date' => false,
		'location_id' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('group_by_earnings_location', $data ?? [], null);
    ...
    */
     ...
     *
     * @param bool|null $group_by_earnings_location 
     *
     * @return self
     */
    public function setGroupByEarningsLocation($group_by_earnings_location)
    {
        if (is_null($group_by_earnings_location)) {
            throw new \InvalidArgumentException('non-nullable group_by_earnings_location cannot be null');
        }
