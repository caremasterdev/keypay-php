 ...
 */
class LeaveAllowanceTemplateLeaveCategoryModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LeaveAllowanceTemplateLeaveCategoryModel';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('leave_accrual_rule_id', $data ?? [], null);
    ...
    */
     ...
     *
     * @param int|null $leave_accrual_rule_id 
     *
     * @return self
     */
    public function setLeaveAccrualRuleId($leave_accrual_rule_id)
    {
        if (is_null($leave_accrual_rule_id)) {
            throw new \InvalidArgumentException('non-nullable leave_accrual_rule_id cannot be null');
        }
