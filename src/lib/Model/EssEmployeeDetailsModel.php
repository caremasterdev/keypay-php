...
class EssEmployeeDetailsModel implements ModelInterface, ArrayAccess
{
    ...
    const EDIT_MODE_EMPLOYEE_PORTAL = 'EmployeePortal';
    const EDIT_MODE_EMPLOYEE_PORTAL_READ_ONLY = 'EmployeePortalReadOnly';
    const EDIT_MODE_BUSINESS_PORTAL = 'BusinessPortal';
    ...
    const TERMINATION_REASON_NONE = 'None';
    const TERMINATION_REASON_VOLUNTARY_CESSATION = 'VoluntaryCessation';
    const TERMINATION_REASON_ILL_HEALTH = 'IllHealth';
    const TERMINATION_REASON_DECEASED = 'Deceased';
    const TERMINATION_REASON_REDUNDANCY = 'Redundancy';
    const TERMINATION_REASON_DISMISSAL = 'Dismissal';
    const TERMINATION_REASON_CONTRACT_CESSATION = 'ContractCessation';
    const TERMINATION_REASON_TRANSFER = 'Transfer';
    const TERMINATION_REASON_OTHER = 'Other';
