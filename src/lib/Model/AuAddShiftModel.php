...
/**
 * AuAddShiftModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AuAddShiftModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuAddShiftModel';
    ...
    */
    ...
    /**
     * Gets recorded_start_time_utc
     *
     * @return \DateTime|null
     */
    public function getRecordedStartTimeUtc()
    {
        return $this->container['recorded_start_time_utc'];
    }

    /**
     * Sets recorded_start_time_utc
     *
     * @param \DateTime|null $recorded_start_time_utc 
     *
     * @return self
     */
    public function setRecordedStartTimeUtc($recorded_start_time_utc)
    {
        if (is_null($recorded_start_time_utc)) {
            throw new \InvalidArgumentException('non-nullable recorded_start_time_utc cannot be null');
        }
        $this->container['recorded_start_time_utc'] = $recorded_start_time_utc;

        return $this;
    }

    /**
     * Gets recorded_end_time_utc
     *
     * @return \DateTime|null
     */
    public function getRecordedEndTimeUtc()
    {
        return $this->container['recorded_end_time_utc'];
    }

    /**
     * Sets recorded_end_time_utc
     *
     * @param \DateTime|null $recorded_end_time_utc 
     *
     * @return self
     */
    public function setRecordedEndTimeUtc($recorded_end_time_utc)
    {
        if (is_null($recorded_end_time_utc)) {
            throw new \InvalidArgumentException('non-nullable recorded_end_time_utc cannot be null');
        }
        $this->container['recorded_end_time_utc'] = $recorded_end_time_utc;
     ...
     * Gets breaks
     *
     * @return \OpenAPI\Client\Model\ShiftBreakModel[]|null
     */
     ...
     * Sets breaks
     *
     * @param \OpenAPI\Client\Model\ShiftBreakModel[]|null $breaks 
     *
     * @return self
     */
    ...
    public function setImage($image)
    {
        ...
        if ((!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", $image))) {
            throw new \InvalidArgumentException("invalid value for \$image when calling AuAddShiftModel., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
