 ...
 */
class AuInitiateEmployeeOnboardingApiModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuInitiateEmployeeOnboardingApiModel';
