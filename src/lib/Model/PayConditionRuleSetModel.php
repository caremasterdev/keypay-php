...
class PayConditionRuleSetModel implements ModelInterface, ArrayAccess
{
    ...
    const PERIOD_TYPE_FORTNIGHTLY = 'Fortnightly';
    const PERIOD_TYPE_MONTHLY = 'Monthly';
    const PERIOD_TYPE_CALENDAR_MONTH = 'CalendarMonth';
    const PERIOD_TYPE_FOUR_WEEKLY = 'FourWeekly';
    const PERIOD_TYPE_SIX_WEEKLY = 'SixWeekly';
    const PERIOD_TYPE_THREE_WEEKLY = 'ThreeWeekly';
    const PERIOD_TYPE_EIGHT_WEEKLY = 'EightWeekly';
    const SHIFT_CONSOLIDATION_OPTION_NONE = 'None';
    const SHIFT_CONSOLIDATION_OPTION_DURATION = 'Duration';
    const SHIFT_CONSOLIDATION_OPTION_SAME_DAY = 'SameDay';
