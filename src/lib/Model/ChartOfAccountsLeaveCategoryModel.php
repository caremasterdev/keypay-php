...
/**
 * ChartOfAccountsLeaveCategoryModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ChartOfAccountsLeaveCategoryModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChartOfAccountsLeaveCategoryModel';
    ...
    protected static array $openAPINullables = [
		...
		'accrue_from_contingent_period' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('accrue_from_contingent_period', $data ?? [], null);
        $this->setIfExists('split_by_location', $data ?? [], null);
    ...
    */
     ...
     *
     * @param bool|null $accrue_from_contingent_period 
     *
     * @return self
     */
    public function setAccrueFromContingentPeriod($accrue_from_contingent_period)
    {
        if (is_null($accrue_from_contingent_period)) {
            throw new \InvalidArgumentException('non-nullable accrue_from_contingent_period cannot be null');
        }
     ...
     *
     * @param bool|null $split_by_location 
     *
     * @return self
     */
    public function setSplitByLocation($split_by_location)
    {
        if (is_null($split_by_location)) {
            throw new \InvalidArgumentException('non-nullable split_by_location cannot be null');
        }
