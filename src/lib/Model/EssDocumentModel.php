 ...
 */
class EssDocumentModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EssDocumentModel';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('date_acknowledged', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param \DateTime|null $date_acknowledged 
     *
     * @return self
     */
    public function setDateAcknowledged($date_acknowledged)
    {
        if (is_null($date_acknowledged)) {
            throw new \InvalidArgumentException('non-nullable date_acknowledged cannot be null');
        }
