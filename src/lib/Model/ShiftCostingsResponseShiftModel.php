 ...
 */
class ShiftCostingsResponseShiftModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShiftCostingsResponseShiftModel';
    ...
    protected static $openAPITypes = [
        ...
        'end_time' => '\DateTime',
        'cost' => 'float',
        'evaluation_results' => '\OpenAPI\Client\Model\RuleEvaluationResult[]',
        'consolidated_shifts' => 'string[]',
        'cost_breakdown' => '\OpenAPI\Client\Model\ShiftCostingBreakdownModel[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('consolidated_shifts', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\RuleEvaluationResult[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\RuleEvaluationResult[]|null $evaluation_results 
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $consolidated_shifts 
     *
     * @return self
     */
    public function setConsolidatedShifts($consolidated_shifts)
    {
        if (is_null($consolidated_shifts)) {
            throw new \InvalidArgumentException('non-nullable consolidated_shifts cannot be null');
        }
     ...
     * Gets cost_breakdown
     *
     * @return \OpenAPI\Client\Model\ShiftCostingBreakdownModel[]|null
     */
     ...
     * Sets cost_breakdown
     *
     * @param \OpenAPI\Client\Model\ShiftCostingBreakdownModel[]|null $cost_breakdown 
     *
     * @return self
     */
