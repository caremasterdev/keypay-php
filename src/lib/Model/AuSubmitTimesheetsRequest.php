 ...
 */
class AuSubmitTimesheetsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuSubmitTimesheetsRequest';
    ...
    protected static $openAPITypes = [
        ...
        'timesheets' => 'array<string,\OpenAPI\Client\Model\AuTimesheetLineModel[]>'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('return_response', $data ?? [], null);
    ...
    */
     ...
     *
     * @param bool|null $return_response 
     *
     * @return self
     */
    public function setReturnResponse($return_response)
    {
        if (is_null($return_response)) {
            throw new \InvalidArgumentException('non-nullable return_response cannot be null');
        }
     ...
     * Gets timesheets
     *
     * @return array<string,\OpenAPI\Client\Model\AuTimesheetLineModel[]>|null
     */
     ...
     * Sets timesheets
     *
     * @param array<string,\OpenAPI\Client\Model\AuTimesheetLineModel[]>|null $timesheets 
     *
     * @return self
     */
