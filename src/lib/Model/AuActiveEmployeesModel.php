 ...
 */
class AuActiveEmployeesModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuActiveEmployeesModel';
    ...
    protected static array $openAPINullables = [
		...
		'number_of_employees_paid' => false,
		'number_of_pay_runs' => false,
		'date_last_pay_run_finalised' => false,
		'date_last_billable_activity' => false,
		'active_emps' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_stp_enabled', $data ?? [], null);
        ...
        $this->setIfExists('number_of_employees_paid', $data ?? [], null);
        $this->setIfExists('number_of_pay_runs', $data ?? [], null);
        $this->setIfExists('date_last_pay_run_finalised', $data ?? [], null);
        $this->setIfExists('date_last_billable_activity', $data ?? [], null);
        $this->setIfExists('active_emps', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets is_stp_enabled
     *
     * @param bool|null $is_stp_enabled 
     *
     * @return self
     */
    public function setIsStpEnabled($is_stp_enabled)
    {
        if (is_null($is_stp_enabled)) {
            throw new \InvalidArgumentException('non-nullable is_stp_enabled cannot be null');
        }
     ...
     *
     * @param int|null $number_of_employees_paid 
     *
     * @return self
     */
    public function setNumberOfEmployeesPaid($number_of_employees_paid)
    {
        if (is_null($number_of_employees_paid)) {
            throw new \InvalidArgumentException('non-nullable number_of_employees_paid cannot be null');
        }
     ...
     *
     * @param int|null $number_of_pay_runs 
     *
     * @return self
     */
    public function setNumberOfPayRuns($number_of_pay_runs)
    {
        if (is_null($number_of_pay_runs)) {
            throw new \InvalidArgumentException('non-nullable number_of_pay_runs cannot be null');
        }
     ...
     *
     * @param \DateTime|null $date_last_billable_activity 
     *
     * @return self
     */
    public function setDateLastBillableActivity($date_last_billable_activity)
    {
        if (is_null($date_last_billable_activity)) {
            throw new \InvalidArgumentException('non-nullable date_last_billable_activity cannot be null');
        }
     ...
     * Sets active_emps
     *
     * @param int|null $active_emps 
     *
     * @return self
     */
    public function setActiveEmps($active_emps)
    {
        if (is_null($active_emps)) {
            throw new \InvalidArgumentException('non-nullable active_emps cannot be null');
        }
