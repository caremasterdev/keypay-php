 ...
 */
class OrdinaryTimeEarningsReportRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrdinaryTimeEarningsReportRequestModel';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('financial_year_ending', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param int|null $financial_year_ending 
     *
     * @return self
     */
    public function setFinancialYearEnding($financial_year_ending)
    {
        if (is_null($financial_year_ending)) {
            throw new \InvalidArgumentException('non-nullable financial_year_ending cannot be null');
        }
