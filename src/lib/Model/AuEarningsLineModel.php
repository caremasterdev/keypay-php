...
class AuEarningsLineModel implements ModelInterface, ArrayAccess
{
    ...
    const LUMP_SUM_CALCULATION_METHOD_A = 'A';
    const LUMP_SUM_CALCULATION_METHOD_B2 = 'B2';
    const LUMP_SUM_CALCULATION_METHOD_NOT_APPLICABLE = 'NotApplicable';
     ...
     *
     * @param double $lump_sum_number_of_pay_periods 
     *
     * @return $this
     */
