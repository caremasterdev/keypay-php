 ...
 */
class EssSatisfactionSurvey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EssSatisfactionSurvey';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('week_start_date', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param \DateTime|null $week_start_date 
     *
     * @return self
     */
    public function setWeekStartDate($week_start_date)
    {
        if (is_null($week_start_date)) {
            throw new \InvalidArgumentException('non-nullable week_start_date cannot be null');
        }
