 ...
 */
class EssCurrentTimesheetsModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EssCurrentTimesheetsModel';
    ...
    */
     ...
     *
     * @param float|null $duration_in_minutes 
     *
     * @return self
     */
