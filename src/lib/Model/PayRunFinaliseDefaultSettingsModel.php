...
class PayRunFinaliseDefaultSettingsModel implements ModelInterface, ArrayAccess
{
    ...
    const EXPORT_JOURNALS_MANUAL = 'Manual';
    const EXPORT_JOURNALS_IMMEDIATE = 'Immediate';
    const EXPORT_JOURNALS_SCHEDULED = 'Scheduled';
    const EXPORT_JOURNALS_TIMELINE_BEFORE = 'Before';
    const EXPORT_JOURNALS_TIMELINE_AFTER = 'After';
    const EXPORT_JOURNALS_TIMELINE_ON = 'On';
    const LODGE_PAY_RUN_MANUAL = 'Manual';
    const LODGE_PAY_RUN_IMMEDIATE = 'Immediate';
    const LODGE_PAY_RUN_SCHEDULED = 'Scheduled';
    const LODGE_PAY_RUN_TIMELINE_BEFORE = 'Before';
    const LODGE_PAY_RUN_TIMELINE_AFTER = 'After';
    const LODGE_PAY_RUN_TIMELINE_ON = 'On';
    const PUBLISH_PAY_SLIPS_TIMELINE_BEFORE = 'Before';
    const PUBLISH_PAY_SLIPS_TIMELINE_AFTER = 'After';
    const PUBLISH_PAY_SLIPS_TIMELINE_ON = 'On';
    ...
    const SUBMIT_TO_PENSION_SYNC_MANUAL = 'Manual';
    const SUBMIT_TO_PENSION_SYNC_IMMEDIATE = 'Immediate';
    const SUBMIT_TO_PENSION_SYNC_SCHEDULED = 'Scheduled';
    const SUBMIT_TO_PENSION_SYNC_TIMELINE_BEFORE = 'Before';
    const SUBMIT_TO_PENSION_SYNC_TIMELINE_AFTER = 'After';
    const SUBMIT_TO_PENSION_SYNC_TIMELINE_ON = 'On';
    const RUN_REPORT_PACKS_MANUAL = 'Manual';
    const RUN_REPORT_PACKS_IMMEDIATE = 'Immediate';
    const RUN_REPORT_PACKS_SCHEDULED = 'Scheduled';
    const RUN_REPORT_PACKS_TIMELINE_BEFORE = 'Before';
    const RUN_REPORT_PACKS_TIMELINE_AFTER = 'After';
    const RUN_REPORT_PACKS_TIMELINE_ON = 'On';
