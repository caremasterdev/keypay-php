...
class AuEmployeePortalSettingsModel implements ModelInterface, ArrayAccess
{
    ...
    const TIMESHEET_SETTING_READ_ONLY = 'ReadOnly';
    const TIMESHEET_SETTING_READ_WRITE = 'ReadWrite';
    const TIMESHEET_SETTING_EDIT_KIOSK = 'EditKiosk';
    const TIMESHEET_SETTING_EDIT_WORK_ZONE_CLOCK_ON_OFF = 'EditWorkZoneClockOnOff';
    const TIMESHEET_SETTING_EDIT_KIOSK_OR_WORK_ZONE_CLOCK_ON_OFF = 'EditKioskOrWorkZoneClockOnOff';
