 ...
 */
class ReportingDimensionValueApiModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReportingDimensionValueApiModel';
    ...
    */
     ...
     *
     * @param string|null $specific_employees 
     *
     * @return self
     */
    public function setSpecificEmployees($specific_employees)
    {
        if (is_null($specific_employees)) {
            throw new \InvalidArgumentException('non-nullable specific_employees cannot be null');
        }
     ...
     * Gets filters
     *
     * @return \OpenAPI\Client\Model\ReportingDimensionValueFilterApiModel[]|null
     */
     ...
     * Sets filters
     *
     * @param \OpenAPI\Client\Model\ReportingDimensionValueFilterApiModel[]|null $filters 
     *
     * @return self
     */
