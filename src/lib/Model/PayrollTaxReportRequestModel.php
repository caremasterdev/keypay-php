 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PayrollTaxReportRequestModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PayrollTaxReportRequestModel';
    ...
    const GROUP_BY_EARNINGS_LOCATION = 'EarningsLocation';
    const GROUP_BY_DEFAULT_LOCATION = 'DefaultLocation';
    const GROUP_BY_EARNINGS_ROLL_UP_LOCATION = 'EarningsRollUpLocation';
