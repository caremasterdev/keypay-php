...
class AuEmployeeFilterModel implements ModelInterface, ArrayAccess
{
    ...
    const FILTER_TYPE_EMPLOYEE = 'Employee';
    const FILTER_TYPE_PAY_SCHEDULE = 'PaySchedule';
    const FILTER_TYPE_EMPLOYMENT_TYPE = 'EmploymentType';
    const FILTER_TYPE_EMPLOYING_ENTITY = 'EmployingEntity';
