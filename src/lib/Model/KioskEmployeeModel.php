...
/**
 * KioskEmployeeModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class KioskEmployeeModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KioskEmployeeModel';
    ...
    {
        $this->setIfExists('pin_expired', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['pin_expired'];
    }

    /**
     * Sets pin_expired
     *
     * @param bool|null $pin_expired 
     *
     * @return self
     */
    public function setPinExpired($pin_expired)
    {
        if (is_null($pin_expired)) {
            throw new \InvalidArgumentException('non-nullable pin_expired cannot be null');
        }
        $this->container['pin_expired'] = $pin_expired;
