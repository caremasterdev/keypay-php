...
/**
 * PayRunEmployeeExpenseResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PayRunEmployeeExpenseResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayRunEmployeeExpenseResponse';
    ...
    protected static $openAPITypes = [
        'employee_expenses' => 'array<string,\OpenAPI\Client\Model\EmployeeExpenseModel[]>',
        'pay_run_id' => 'int'
    ];
    ...
    */
     ...
     *
     * @param array<string,\OpenAPI\Client\Model\EmployeeExpenseModel[]>|null $employee_expenses 
     *
     * @return self
     */
