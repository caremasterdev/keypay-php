...
/**
 * CreateBusinessAccessModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateBusinessAccessModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateBusinessAccessModel';
    ...
    {
        $this->setIfExists('suppress_notification_emails', $data ?? [], null);
        $this->setIfExists('merge_existing_access', $data ?? [], null);
    ...
    */
     ...
     *
     * @param bool|null $suppress_notification_emails 
     *
     * @return self
     */
    public function setSuppressNotificationEmails($suppress_notification_emails)
    {
        if (is_null($suppress_notification_emails)) {
            throw new \InvalidArgumentException('non-nullable suppress_notification_emails cannot be null');
        }
     ...
     *
     * @param bool|null $merge_existing_access 
     *
     * @return self
     */
    public function setMergeExistingAccess($merge_existing_access)
    {
        if (is_null($merge_existing_access)) {
            throw new \InvalidArgumentException('non-nullable merge_existing_access cannot be null');
        }
