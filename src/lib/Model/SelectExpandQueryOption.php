    ...
    */
    ...
    public function setRawSelect($raw_select)
    {
        if (is_null($raw_select)) {
            throw new \InvalidArgumentException('non-nullable raw_select cannot be null');
        }
    ...
    public function setRawExpand($raw_expand)
    {
        if (is_null($raw_expand)) {
            throw new \InvalidArgumentException('non-nullable raw_expand cannot be null');
        }
