 ...
 */
class ManagerDashboardModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagerDashboardModel';
    ...
    protected static $openAPITypes = [
        'pending_leave_requests' => '\OpenAPI\Client\Model\ManagerItemCountModel',
        'submitted_timesheets' => '\OpenAPI\Client\Model\ManagerItemCountModel',
        'pending_expense_requests' => '\OpenAPI\Client\Model\ManagerItemCountModel'
    ];
    ...
    protected static array $openAPINullables = [
		...
		'submitted_timesheets' => false,
		'pending_expense_requests' => false
    ];
    ...
    {
        $this->setIfExists('pending_leave_requests', $data ?? [], null);
        $this->setIfExists('submitted_timesheets', $data ?? [], null);
        $this->setIfExists('pending_expense_requests', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\ManagerItemCountModel|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ManagerItemCountModel|null $pending_leave_requests pending_leave_requests
     *
     * @return self
     */
    public function setPendingLeaveRequests($pending_leave_requests)
    {
        if (is_null($pending_leave_requests)) {
            throw new \InvalidArgumentException('non-nullable pending_leave_requests cannot be null');
        }
     ...
     *
     * @param \OpenAPI\Client\Model\ManagerItemCountModel|null $submitted_timesheets submitted_timesheets
     *
     * @return self
     */
    public function setSubmittedTimesheets($submitted_timesheets)
    {
        if (is_null($submitted_timesheets)) {
            throw new \InvalidArgumentException('non-nullable submitted_timesheets cannot be null');
        }
     ...
     *
     * @param \OpenAPI\Client\Model\ManagerItemCountModel|null $pending_expense_requests pending_expense_requests
     *
     * @return self
     */
    public function setPendingExpenseRequests($pending_expense_requests)
    {
        if (is_null($pending_expense_requests)) {
            throw new \InvalidArgumentException('non-nullable pending_expense_requests cannot be null');
        }
