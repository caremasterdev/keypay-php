 ...
 */
class EmployeeExpensePaymentSummaryModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmployeeExpensePaymentSummaryModel';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ytd_amount', $data ?? [], null);
    ...
    */
     ...
     * Sets ytd_amount
     *
     * @param float|null $ytd_amount 
     *
     * @return self
     */
    public function setYtdAmount($ytd_amount)
    {
        if (is_null($ytd_amount)) {
            throw new \InvalidArgumentException('non-nullable ytd_amount cannot be null');
        }
