 ...
 */
class AuPayRunEarningsLineResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuPayRunEarningsLineResponseModel';
