 ...
 */
class AuEssEmployeeDetailsViewModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuEssEmployeeDetailsViewModel';
