 ...
 */
class AuIndividualTimesheetLineModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuIndividualTimesheetLineModel';
