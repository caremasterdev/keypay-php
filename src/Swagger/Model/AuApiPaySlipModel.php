...
class AuApiPaySlipModel implements ModelInterface, ArrayAccess
{
    ...
    const EMPLOYEE_BASE_RATE_UNIT_HOURLY = 'Hourly';
    const EMPLOYEE_BASE_RATE_UNIT_ANNUALLY = 'Annually';
    const EMPLOYEE_BASE_RATE_UNIT_FIXED = 'Fixed';
    const EMPLOYEE_BASE_RATE_UNIT_DAILY = 'Daily';
    const EMPLOYEE_BASE_RATE_UNIT_MONTHLY = 'Monthly';
     ...
     *
     * @param double $pre_tax_deductions_ytd 
     *
     * @return $this
     */
     ...
     *
     * @param double $post_tax_deductions_ytd 
     *
     * @return $this
     */
     ...
     *
     * @param double $employee_base_rate 
     *
     * @return $this
     */
